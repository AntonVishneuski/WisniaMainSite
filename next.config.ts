...
const csp = [
  ...
  "font-src 'self' data:",
  `connect-src 'self'${isDev ? ' ws:' : ''} https://*.public.blob.vercel-storage.com https://www.googletagmanager.com https://*.google-analytics.com https://stats.g.doubleclick.net https://www.facebook.com https://connect.facebook.net`,
