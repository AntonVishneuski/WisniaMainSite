...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."_locales" AS ENUM('pl', 'ru');
  CREATE TYPE "public"."enum_prices_tab" AS ENUM('kosmetologia', 'laser', 'cialo', 'pakiety');
  CREATE TYPE "public"."enum_reviews_source" AS ENUM('Google', 'Booksy');
  ...
  CREATE TABLE "before_after_locales" (
  	"caption" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" integer NOT NULL
  ...
  CREATE TABLE "settings" (
  	...
  	"booksy_url" varchar DEFAULT 'https://wisniabeauty.booksy.com/a',
  	"google_rating" varchar DEFAULT '5,0',
  	"booksy_rating" varchar DEFAULT '4,9',
  ...
  ALTER TABLE "before_after_locales" ADD CONSTRAINT "before_after_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."before_after"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE UNIQUE INDEX "before_after_locales_locale_parent_id_unique" ON "before_after_locales" USING btree ("_locale","_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "before_after_locales" CASCADE;
  ...
  DROP TYPE "public"."enum_prices_tab";
